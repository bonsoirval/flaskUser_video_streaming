...
APP_NAME = "Enhanced Image Processing in Web Video Surveillance System"
...
USER_ENABLE_CONFIRM_EMAIL = False #True  # Force users to confirm their email
USER_ENABLE_FORGOT_PASSWORD = True  # Allow users to reset their passwords
USER_ENABLE_EMAIL = False #True  # Register with Email
